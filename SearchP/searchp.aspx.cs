...
namespace SearchP
{
    public partial class searchp : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlcomm = new SqlCommand("searchdate29", sqlconn);
        ...
        protected void Button3_Click1(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                ...
                dr["GroupName"] = GridView1.Rows[i].Cells[8].Text;
                dr["SystemID"] = GridView1.Rows[i].Cells[9].Text;
                dr["SystemName"] = GridView1.Rows[i].Cells[10].Text;
                dr["5185"] = GridView1.Rows[i].Cells[11].Text;
                dr["5192"] = GridView1.Rows[i].Cells[12].Text;
                dr["5207"] = GridView1.Rows[i].Cells[13].Text;
                dr["6177"] = GridView1.Rows[i].Cells[14].Text;
                dr["6206"] = GridView1.Rows[i].Cells[15].Text;
                dr["6207"] = GridView1.Rows[i].Cells[16].Text;
                dr["6299"] = GridView1.Rows[i].Cells[17].Text;
                dr["6356"] = GridView1.Rows[i].Cells[18].Text;
                //dr["6358"] = GridView1.Rows[i].Cells[19].Text;
                //dr["6362"] = GridView1.Rows[i].Cells[20].Text;
                //dr["6363"] = GridView1.Rows[i].Cells[21].Text;
                //dr["6364"] = GridView1.Rows[i].Cells[22].Text;
                //dr["6365"] = GridView1.Rows[i].Cells[23].Text;
                //dr["6367"] = GridView1.Rows[i].Cells[24].Text;
                //dr["6368"] = GridView1.Rows[i].Cells[25].Text;
                //dr["6369"] = GridView1.Rows[i].Cells[26].Text;
                //dr["6372"] = GridView1.Rows[i].Cells[27].Text;
                //dr["6626"] = GridView1.Rows[i].Cells[28].Text;
                               dt.Rows.Add(dr);
            }
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            dt2.Columns.Add("GroupName");
            dt2.Columns.Add("SystemID");
            ...
            foreach (GridViewRow row2 in GridView1.Rows)
            {
                ...
                dr2["GroupName"] = GridView1.Rows[j].Cells[8].Text;
                dr2["SystemID"] = GridView1.Rows[j].Cells[9].Text;
                dr2["SystemName"] = GridView1.Rows[j].Cells[10].Text;
                //dr["5185"] = GridView1.Rows[i].Cells[11].Text;
                //dr["5192"] = GridView1.Rows[i].Cells[12].Text;
                //dr["5207"] = GridView1.Rows[i].Cells[13].Text;
                //dr["6177"] = GridView1.Rows[i].Cells[14].Text;
                ...
                //dr["6299"] = GridView1.Rows[i].Cells[17].Text;
                //dr["6356"] = GridView1.Rows[i].Cells[18].Text;
                dr2["6358"] = GridView1.Rows[j].Cells[19].Text;
                dr2["6362"] = GridView1.Rows[j].Cells[20].Text;
                dr2["6363"] = GridView1.Rows[j].Cells[21].Text;
                dr2["6364"] = GridView1.Rows[j].Cells[22].Text;
                dr2["6365"] = GridView1.Rows[j].Cells[23].Text;
                dr2["6367"] = GridView1.Rows[j].Cells[24].Text;
                dr2["6368"] = GridView1.Rows[j].Cells[25].Text;
                dr2["6369"] = GridView1.Rows[j].Cells[26].Text;
                dr2["6372"] = GridView1.Rows[j].Cells[27].Text;
                dr2["6626"] = GridView1.Rows[j].Cells[28].Text;
                dt2.Rows.Add(dr2);
            }
